...
// Case 1: f16 64x64 partial
extern "C" __global__ AICORE void TPRELU_f16_64x64_partial(__gm__ uint16_t *src0, __gm__ uint16_t *src1, __gm__ uint16_t *dst);

void LaunchTPRELU_f16_64x64_partial(uint16_t *src0, uint16_t *src1, uint16_t *dst, void *stream) {
    TPRELU_f16_64x64_partial<<<1, nullptr, stream>>>((__gm__ uint16_t *)src0, (__gm__ uint16_t *)src1, (__gm__ uint16_t *)dst);
}
...
// Case 5: f32 64x64 partial
extern "C" __global__ AICORE void TPRELU_f32_64x64_partial(__gm__ float *src0, __gm__ float *src1, __gm__ float *dst);

void LaunchTPRELU_f32_64x64_partial(float *src0, float *src1, float *dst, void *stream) {
    TPRELU_f32_64x64_partial<<<1, nullptr, stream>>>((__gm__ float *)src0, (__gm__ float *)src1, (__gm__ float *)dst);
}
